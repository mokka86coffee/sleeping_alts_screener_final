...
# КОРЕНЬ, не output/: файл ручной, как unlocks.json — правится
# человеком и живёт под git. В output/ его никто не кладёт, а сам
# output машинный, в .gitignore и под ротацией; константа смотрела
# туда по ошибке, и календарь честно говорил «файла нет», хотя файл
# лежал рядом (найдено 23.08 по «3 из 5» в окне рынка).
