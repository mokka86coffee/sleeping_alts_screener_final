...
# КОРЕНЬ, не output/: «путь ручной, тот же, что уже работает
# дважды» — как и обещает шапка модуля. Прежняя константа смотрела в
# output/, куда файл никто не кладёт: журнал решений читался из
# пустоты, и человеческий счёт всегда был бы нулём (найдено 23.08).
