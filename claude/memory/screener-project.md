...
- Earlier loss (told 26.09): about $10,000 on a STRK long in December 2025, on the spike 0.12 → 0.29 that landed in the old daily shelf (R22) on record volume (R29) and then bled to 0.04 for nine months while OI stayed at the top's level (positions averaged down). Same picture as ONE/PLAY: a vertical on record volume read as a start instead of an end.
