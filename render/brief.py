...
(function () {
  ...
  function buildBrief() {
    ...
    if (M.frozen) {
      bg.push({
      p: 'Рынок сегодня замер. Лучшая монета ' +
        'дня прибавила ' + pct(M.maxChange, 0) + ', ' +
        'и дальше плюс двадцати ушли всего ' + (M.tail || 0) +
        ' монет — при живом рынке их бывают десятки. ' +
        'Ехать сегодня некуда.',
        h: 'Рынок сегодня <span class="warn">замер</span>. Лучшая монета ' +
      ...
      bg.push({
      p: '', h: 'Рынок <span class="gd">двигается</span>. Лучшая монета дня ' +
