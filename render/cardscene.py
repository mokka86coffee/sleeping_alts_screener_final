...
Своих данных у модуля нет, как и у подиума: звезда приходит из
window.ORB.stars через podium.py. Значения для нижнего ящика подиум
передаёт уже свёрстанными — своей вёрсткой тех же чисел модуль бы
разошёлся с залом при первой правке.
