...
.fr-lnk{display:inline-flex;align-items:center;gap:6px;height:28px;
        padding:0 14px;border-radius:14px;background:#121217;
        border:1px solid #1f1f28;font-size:8px;font-weight:400;
        letter-spacing:1.5px;color:#8a8a96;white-space:nowrap;
        transition:background .14s,color .14s,border-color .14s}
.fr-lnk:hover{background:#1c1a14;color:var(--fl);
              border-color:color-mix(in srgb,var(--fc) 45%,transparent)}
.fr-lnk i{font-style:normal;font-size:9px;opacity:.6}
...
.fr-lnk.off{opacity:.35;cursor:default}
...
@media (max-width:1240px){
  ...
  .fr-in{grid-template-columns:150px 64px 96px 92px 1fr 92px 86px 84px 78px;
