...
# Палитра стадий FLOW — ЕДИНСТВЕННЫЙ источник. Орбита и зал пекут
# из него свои JS-таблицы при сборке; их встроенные копии — запасные
# на случай пустого поля и обязаны совпадать с этим словарём.
# До 22.08 таблица жила в двух JS дословными копиями, канала между
# ними не было, и «безобидно до первой правки цветов» из комментария
# зала уже начинало сбываться: запасные значения NONE разошлись.
CASE_STRAT = {
